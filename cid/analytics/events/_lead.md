...
| Approved wave 1, `theme/tone/04` `D16`: *"Measure freely, display none of it"* | approved spec | No event may require or imply a player-facing surface. This domain owes `vocabulary` no player-facing string. |
